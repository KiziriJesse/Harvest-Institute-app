...
class CourseFinancesTaxation extends StatelessWidget {
  static const String routeName = '/course-finances-taxation';
  ...
  const CourseFinancesTaxation({super.key});
            ...
            Container(
              ...
              child: Column(
                ...
                children: const [
                  ...
                  SizedBox(height: 10),
                  Text(
                    'Gain a comprehensive understanding of corporate finance, financial planning, and the essential aspects of modern taxation for businesses and individuals.',
                  ...
                  Text('- Investment Appraisal Techniques'),
                  Text('- Local and International Tax Law'),
                  Text('- Tax Planning and Compliance'),
                  SizedBox(height: 20),
