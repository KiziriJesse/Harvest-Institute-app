...
class CourseFrontend extends StatelessWidget {
  static const String routeName = '/course-frontend';
  ...
  const CourseFrontend({super.key});
            ...
            Container(
              ...
              child: Column(
                ...
                children: const [
                  ...
                  SizedBox(height: 10),
                  Text(
                    'Build stunning, interactive user interfaces for the web. This comprehensive course covers modern web standards, frameworks, and design principles for high-quality frontend development.',
                  ...
                  Text('- Responsive Design and UI/UX Principles'),
                  Text('- Modern Frameworks (React/Vue/Angular)'),
                  Text('- State Management and Component Lifecycle'),
