...
import 'package:harvest_institute_mobile_app/screens/course_leadership_governance.dart';
import 'package:harvest_institute_mobile_app/screens/course_people_teams.dart'; 

class SchoolLeadershipScreen extends StatelessWidget {
  static const String routeName = '/school-leadership';
  ...
  const SchoolLeadershipScreen({super.key});
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // Image for the School of Leadership
            ClipRRect(
              borderRadius: BorderRadius.circular(10.0),
              child: Image.asset(
                'assets/images/leadership.webp', 
                fit: BoxFit.cover,
                height: 200,
              ),
            ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'The Harvest Institute School of Leadership & Ministry is dedicated to building visionary leaders who drive positive change, operate with integrity, and foster empowering environments. We prepare leaders to advance God’s kingdom with integrity, collaboration, and a sense of mission urgency through specialized training in ministry.',
                  ...
                  const SizedBox(height: 10),
                  _buildCourseTile(context, 'Embracing Revival', CourseLeadershipGovernance.routeName),
                  _buildCourseTile(context, 'The Foundation of the Word', CoursePeopleTeams.routeName),
                  _buildCourseTile(context, 'Church Life, Order & Structure', CoursePeopleTeams.routeName),
                  _buildCourseTile(context, 'Church Growth', CoursePeopleTeams.routeName),
                  // Add more leadership-related courses if available
                ],
              ),
            ),
            ...
            ElevatedButton(
              ...
              child: const Text(
                'Apply for School of Leadership & Ministry',
