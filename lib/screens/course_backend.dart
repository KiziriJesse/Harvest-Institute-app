...
class CourseBackend extends StatelessWidget {
  static const String routeName = '/course-backend';
  static const Color primaryBlue = Color.fromARGB(255, 2, 2, 2);
            ...
            Container(
              ...
              child: Column(
                ...
                children: const [
                  ...
                  SizedBox(height: 10),
                  Text(
                    'Master the art of server-side programming, database management, and API development to build robust and scalable applications. This course covers modern backend technologies and architectures.',
                  ...
                  SizedBox(height: 10),
                  Text('- Server-Side Languages (Node.js/Python)'),
                  Text('- Database Systems (SQL/NoSQL)'),
                  Text('- RESTful API Design and Implementation'),
                  Text('- Authentication and Security'),
                  Text('- Cloud Deployment and Scaling'),
                  SizedBox(height: 20),
