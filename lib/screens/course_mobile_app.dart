...
class CourseMobileApp extends StatelessWidget {
  static const String routeName = '/course-mobile-app';
  ...
  const CourseMobileApp({super.key});
            ...
            Container(
              ...
              child: Column(
                ...
                children: const [
                  ...
                  SizedBox(height: 10),
                  Text(
                    'Learn to build cross-platform mobile applications for iOS and Android using modern frameworks. Focus on UI/UX, performance, and native feature integration.',
                  ...
                  SizedBox(height: 10),
                  Text('- Flutter/React Native Fundamentals'),
                  Text('- Mobile UI/UX Design Principles'),
                  Text('- State Management and Architecture'),
                  Text('- API Integration and Offline Storage'),
                  Text('- App Deployment to Stores'),
                  SizedBox(height: 20),
