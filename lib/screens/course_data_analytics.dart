...
class CourseDataAnalytics extends StatelessWidget {
  static const String routeName = '/course-data-analytics';
  ...
  const CourseDataAnalytics({super.key});
            ...
            Container(
              ...
              child: Column(
                ...
                children: const [
                  ...
                  SizedBox(height: 10),
                  Text(
                    'Learn to transform raw data into actionable business insights using powerful tools and statistical methods. This course is essential for data-driven decision-making.',
                  ...
                  Text('- Data Visualization and Reporting (Power BI, Tableau)'),
                  Text('- SQL and Database Fundamentals'),
                  Text('- Introduction to Predictive Analytics'),
                  SizedBox(height: 20),
